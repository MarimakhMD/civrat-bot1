...
function registerAdminPanel({ registry, runtimeFactory }) {
  ...
  registry.registerButton({ customId: Id.ACTIVATE, permissions: adminOnly, execute: (context) => routes.openActivate(context, runtime()) });
  ...
  registry.registerModal({ customId: Id.ACTIVATE_SUBMIT, permissions: adminOnly, execute: (context) => routes.submitActivate(context, runtime()) });
  registry.registerModal({ customId: Id.REMOVE_SUBMIT, permissions: adminOnly, execute: (context) => routes.submitDeactivate(context, runtime(), "remove") });
  registry.registerModal({ customId: Id.REVOKE_SUBMIT, permissions: adminOnly, execute: (context) => routes.submitDeactivate(context, runtime(), "revoke") });
  ...
  registry.registerButton({ matcher: prefix(Id.ACTIVATE_PREFIX), permissions: adminOnly, execute: (context) => routes.openActivate(context, runtime(), context.envelope.customId.slice(Id.ACTIVATE_PREFIX.length)) });
  registry.registerButton({ matcher: prefix(Id.REMOVE_PREFIX), permissions: adminOnly, execute: (context) => routes.openDeactivate(context, runtime(), context.envelope.customId.slice(Id.REMOVE_PREFIX.length), "remove") });
  registry.registerButton({ matcher: prefix(Id.REVOKE_PREFIX), permissions: adminOnly, execute: (context) => routes.openDeactivate(context, runtime(), context.envelope.customId.slice(Id.REVOKE_PREFIX.length), "revoke") });
