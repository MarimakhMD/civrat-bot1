...
const LogsComponentId=Object.freeze({SECTION:"civrat:v1:logs:section",TOGGLE:"civrat:v1:logs:toggle",CATEGORY:"civrat:v1:logs:category",CHANNEL_PREFIX:"civrat:v1:logs:channel",PREVIEW:"civrat:v1:logs:preview",BACK:"civrat:v1:logs:back",HOME:"civrat:v1:logs:home"});
