...
const WelcomeGoodbyeConfigSchema = Object.freeze({
  ...
  // `template-civrat` est accepté par le schéma mais n'est exposé/persisté que
  // pour le guildId autorisé (voir selectWelcomeTemplate + getForGuild) : les
  // autres serveurs ne peuvent ni le voir ni le conserver.
  [Key.WELCOME_TEMPLATE]: { type: "enum", values: ["template-1", "template-2", "template-3", "template-civrat"] },
